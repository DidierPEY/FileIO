namespace llt.Test
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			// tabPage1
			// 
			this.tabPage1.Controls.Add(this.chkFTPUsePassive);
			...
			this.chkFTPUsePassive.Checked = true;
			this.chkFTPUsePassive.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkFTPUsePassive.Location = new System.Drawing.Point(472, 19);
			this.chkFTPUsePassive.Name = "chkFTPUsePassive";
			this.chkFTPUsePassive.Size = new System.Drawing.Size(83, 17);
			this.chkFTPUsePassive.TabIndex = 45;
			this.chkFTPUsePassive.Text = "Mode passif";
